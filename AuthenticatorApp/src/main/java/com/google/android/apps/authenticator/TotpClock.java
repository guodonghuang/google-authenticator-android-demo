...
public class TotpClock implements SharedPreferences.OnSharedPreferenceChangeListener {
  ...
  public long currentTimeMillis() {
    ...
    Log.e("+++++++++++++", "currentTimeMillis format1: "+format1);


    Log.e("+++++++++++++", "getTimeCorrectionMinutes: "+getTimeCorrectionMinutes() * Utilities.MINUTE_IN_MILLIS );
    Log.e("+++++++++++++", "currentTimeMillis: "+System.currentTimeMillis() + getTimeCorrectionMinutes() * Utilities.MINUTE_IN_MILLIS );

    Date date = new Date(System.currentTimeMillis() + getTimeCorrectionMinutes() * Utilities.MINUTE_IN_MILLIS );
    String format = simpleDateFormat.format(date);
    Log.e("+++++++++++++", "currentTimeMillis format2: "+format);
